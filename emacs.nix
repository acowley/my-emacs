...
in {
  ...
  myemacsGccPkgs = (self.emacsPackagesFor self.emacsPgtkGcc).overrideScope' self.myEmacsPackageOverrides;
  myemacsGcc = ((self.emacsPackagesFor self.emacsPgtkGcc).overrideScope' self.myEmacsPackageOverrides).emacsWithPackages self.myEmacsPackages;
